            ...
            <section className="feed-post-index">
                ...
                <div className="feed-post-index-body">
                    {Object.values(this.props.posts).map((post) => (
                        <PostIndexItem key={post.id} post={post} openModal={this.props.openModal} closeModal={this.props.closeModal} deletePost={this.props.deletePost} currentUserId={this.props.currentUser.id} users={this.props.users}/>
                    ))}
                </div>
